...
export async function POST(req){
 try{
  ...
  const cfgRes=await sb.rpc('get_aqlevon_runtime_config');if(cfgRes.error)throw cfgRes.error;const cfg=cfgRes.data||{};
 ...
 }catch(e){return NextResponse.json({message:e?.message||'فشلت دورة AQLEVON AI.'},{status:500})}
}
