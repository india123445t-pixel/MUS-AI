export default {
  ...
  'chat.temporary': 'Hidden from history · stored locally', 'chat.temporaryChat': 'History-hidden chat',
  ...
  'chat.researchHint': 'Searches the web with sources, then uses a deeper reasoning path for the answer.',
  'chat.dictate': 'Dictate', 'chat.dictateUnavailable': 'Voice dictation is not supported by this browser.', 'chat.thinkLonger': 'Think deeper', 'chat.thinkLongerHint': 'Use a deeper reasoning path for this request', 'chat.thinkLongerAutomatic': 'Enable a deeper reasoning path for this request. It may take longer.',
  ...
  'apps.n.web-search': 'Web search', 'apps.d.web-search': 'Source-backed web search through an independent AQLEVON tool without changing the sovereign model runtime.',
  ...
  'apps.browserNoticeTitle': 'Tools and adapter status',
  'apps.browserNotice': 'Web search works when its server-side search engine is configured. Tools marked Adapter required are not connected yet. Do not enter access tokens or secrets in the browser.',
