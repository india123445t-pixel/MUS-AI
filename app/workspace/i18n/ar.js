export default {
  ...
  'chat.researchHint': 'يبحث في الويب بالمصادر ثم يستخدم مسار استدلال أعمق لصياغة الإجابة.',
  'chat.dictate': 'إملاء', 'chat.dictateUnavailable': 'الإملاء الصوتي غير مدعوم في هذا المتصفح.', 'chat.thinkLonger': 'فكّر أعمق', 'chat.thinkLongerAutomatic': 'فعّل مسار استدلال أعمق لهذا الطلب. قد يستغرق وقتًا أطول.',
  ...
  'apps.n.web-search': 'بحث الويب', 'apps.d.web-search': 'بحث ويب بالمصادر عبر أداة AQLEVON المستقلة، دون تغيير محرك النموذج الأساسي.',
  ...
  'apps.browserNoticeTitle': 'حالة الأدوات والـAdapters',
  'apps.browserNotice': 'بحث الويب يعمل عندما يكون محركه الخادمي مهيأ. الأدوات الأخرى التي تحمل «يحتاج Adapter» غير موصولة بعد. لا تُدخل رموز وصول أو أسرارًا في المتصفح.',
