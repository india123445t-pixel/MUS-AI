...
} from '../lib/mus/control-center-compat.js';
import { buildTaskContract, detectPlanningIntent } from '../lib/mus/kernel.js';
import { classifyProviderFailure, safeProviderDiagnostic, PROVIDER_ERROR_CLASSES } from '../lib/mus/providers.js';
import {
...
} from '../lib/mus/frozen-foundations.js';
import { createTrustedRegistry } from '../lib/mus/tool-registry.js';
import { createActionIntent, issuePermit } from '../lib/mus/authority.js';
...
function executionFixture(){
  ...
  const intent=createActionIntent({task_id:'t1',contract_id:'c1',semantic_action:'update',resource:{provider:'github',tenant:'owner',project:'MUS-AI',environment:'staging',resource_id:'repo1'},parameters:{path:'x',content:'y'},capabilities:['WRITE']});
