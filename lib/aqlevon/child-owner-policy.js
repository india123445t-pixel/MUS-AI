...
export const CHILD_OWNER_POLICY_CATALOG=Object.freeze([
  ...
  {id:'automatic_promotion',label:'الترقية التلقائية',description:'يسمح لمسار طفل موصول بترقية مخرجاته تلقائيًا عندما تدعم البنية ذلك.'},
  {id:'gpu_request_allowed',label:'السماح بطلب GPU',description:'يسمح للمختبر بتجهيز طلب GPU؛ لا يبدأ إنفاقًا مدفوعًا من تلقاء نفسه.'},
]);
...
export function normalizeChildOwnerPolicy(raw={}){
  ...
  return {
    ...
    automatic_promotion:raw.automatic_promotion===true,
    gpu_request_allowed:raw.gpu_request_allowed===true,
