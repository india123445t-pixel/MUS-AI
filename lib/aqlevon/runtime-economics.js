...
export function summarizeVerifiedEfficiency(receipts=[],{evaluationDecisionReceipts=[],objectiveVerifierApprovals=[],verificationJoins=[],managerApprovedVerificationReceiptSha256=[]}={}){
  ...
  for(const receipt of attempts){
    ...
    const verification=resolveAttemptVerification(receipt,{evaluationDecisionReceipts,objectiveVerifierApprovals,verificationJoins,managerApprovedVerificationReceiptSha256});
