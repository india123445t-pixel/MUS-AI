import {buildApprovedTruthAuthority,buildRuntimePopulationScope,resolveAttemptVerification,verifyRuntimeAttemptReceipt} from './runtime-receipts.js';
...
function invalidEfficiencySummary(attemptReceipts,reasons){
  ...
  return Object.freeze({
    ...
    status:'INVALID',
    truth_policy:'per_attempt_objective_receipt_only',
    efficiency_scope_kind:RUNTIME_EFFICIENCY_SCOPE_KIND,
    population_scope:buildRuntimePopulationScope(attempts),
...
export function summarizeVerifiedEfficiency(attemptReceipts=[],truth={}){
  ...
  let verifiedSuccesses=0,verifiedByObjective=0,truthConflicts=0;
  ...
  return Object.freeze({
    ...
    truth_policy:'per_attempt_objective_receipt_only',
    efficiency_scope_kind:RUNTIME_EFFICIENCY_SCOPE_KIND,
    population_scope:buildRuntimePopulationScope(attemptReceipts),
