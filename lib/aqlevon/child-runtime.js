...
export function resolveChildRuntime(){
  return Object.freeze({
    endpoint:normalize(process.env.AQLEVON_CHILD_MODEL_URL||'https://api.runpod.ai/v2/tawpsv5oxepmo4/runsync'),
    model:String(process.env.AQLEVON_CHILD_MODEL_NAME||'AQLEVON-4B-Auth16'),
    key:String(process.env.AQLEVON_CHILD_MODEL_KEY||process.env.RUNPOD_API_KEY||''),
