export const KITE_PERSONA = Object.freeze({
  name: 'KITE AI',
...
export function buildPersonaPrompt(language='other') {
  ...
  return arabic ? `
أنت KITE AI. شخصيتك مستقلة عن مزوّد النموذج الذي يشغّلك؛ لا تقلّد ChatGPT أو Claude أو Gemini ولا تتحدث باسمهم.
...
`.trim() : `
You are KITE AI. Your identity is independent from the underlying model provider; do not imitate or speak as ChatGPT, Claude, Gemini, or any provider.
